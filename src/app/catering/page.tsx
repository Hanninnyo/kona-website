          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-kona-espresso/70 mb-8 leading-relaxed">
                Bring the authentic Hawaiian coffee experience to your next
                event. Our mobile coffee truck delivers aloha wherever you need
                it in the Bay Area.
              </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-kona-espresso/70 text-lg max-w-2xl mx-auto">
              From intimate gatherings to large corporate events, we bring the
              aloha spirit to every celebration
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-kona-taupe/20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-kona-espresso/70 text-lg max-w-2xl mx-auto">
              Choose the package that fits your event, or let us create a custom
              experience
            </p>
          </motion.div>
            ...
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <Card
                  className={`h-full ${
                    pkg.popular
                      ? "border-2 border-kona-teal shadow-kona-medium"
                      : "border-0 shadow-kona-soft"
                  }`}
                >
                    ...
                    <ul className="space-y-3">
                      {pkg.features.map((feature, idx) => (
                        ...
                        >
                          ...
                          <span className="text-kona-espresso/80">
                            {feature}
                          </span>
                        </li>
                      ))}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-kona-white/90 mb-8">
              Contact us today to discuss your catering needs and get a custom
              quote
            </p>
              ...
              <Card className="bg-kona-white/10 border-kona-white/20 text-center">
                <CardContent className="p-6">
                  ...
                  <a
                    ...
                    className="text-kona-white/90 hover:text-kona-teal transition-colors"
                  >
                    (408) 513-6455
                  </a>
                </CardContent>
