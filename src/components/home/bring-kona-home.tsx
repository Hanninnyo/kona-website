    ...
    >
      <div className="mx-auto max-w-page px-5 sm:px-8">
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:gap-16">
          <div role="tablist" aria-label="Kona coffees" className="flex flex-col gap-8">
...
function BeanDetail({ bean }: { bean: Bean }) {
  return (
    <div key={bean.id} className="discovery-enter border-t border-sand-50/15 pt-10 lg:border-t-0 lg:border-l lg:pl-16 lg:pt-0">
      <p className="font-body text-eyebrow uppercase tracking-[0.18em] text-sand-100/60">
        {bean.classification}
      </p>
